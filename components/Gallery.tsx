...
export default function GalleryPage() {
  ...
  >
    <div
      className="relative w-[95vw] h-[95vh] max-w-5xl bg-white/10 rounded-2xl p-8 backdrop-blur-lg shadow-2xl overflow-auto"
      onClick={(e) => e.stopPropagation()}
    >
      <Button
        variant="ghost"
        size="icon"
        className="absolute top-10 right-2 text-white hover:bg-white/20 z-[60]"
        onClick={() => setSelectedImage(null)}
      >
        <X className="h-6 w-6" />
      </Button>
      <div className="flex flex-col lg:flex-row gap-8 h-full mt-12">
